...
\pagestyle{plain}
\begin{appendices}
    \section{Selected ETPs}
    \input{section/Selected_ETPs}
    \newpage
    
    \section{Equal Weighted Portfolios}\label{EW_Portfolios}
    \input{section/EW_Portfolios}
    \newpage
    
    \section{Inverse Variance Portfolios}\label{IV_Portfolios}
    \input{section/IV_Portfolios}
    \newpage
    
    \section{Appendix D: Markowitz Minimum Variance Portfolios}\label{MMV_Portfolios}
